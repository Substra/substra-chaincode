...
func TestModelComposition(t *testing.T) {
	testTable := []struct {
		parent1 asset.AssetType // head for composite
		parent2 asset.AssetType // trunk for composite
		child   asset.AssetType
	}{
...
func trainStart(db *LedgerDB, tupleType asset.AssetType, tupleKey string) (interface{}, error) {
	switch tupleType {
	case TraintupleType:
...
func trainSuccess(db *LedgerDB, tupleType asset.AssetType, tupleKey string) (interface{}, error) {
	switch tupleType {
	case TraintupleType:
...
func trainFail(db *LedgerDB, tupleType asset.AssetType, tupleKey string) (interface{}, error) {
